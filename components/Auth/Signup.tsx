              ...
              <div className="xl:gap-15 flex flex-wrap items-center justify-between gap-10">
                ...
                >
                  ...
                  <span className="group flex h-[1lh] items-center">
                    <span className="group-peer-checked:!bg-primary flex h-5 min-w-[20px] items-center justify-center rounded border-gray-300 bg-gray-100 text-blue-600 dark:border-gray-600 dark:bg-gray-700">
                      <svg
